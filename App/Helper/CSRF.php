...
class CSRF
{
    ...
    public static function generateToken()
    {
        ...
        // Only generate new token if one doesn't exist or has expired
        if (!isset($_SESSION[self::$tokenName])) {
            $token = bin2hex(random_bytes(32));
            $_SESSION[self::$tokenName] = $token;
            $_SESSION[self::$tokenExpiryName] = time() + self::$tokenLifetime;
        }
    ...
    public static function validateToken($submittedToken)
    {
        ...
        if (time() > $_SESSION[self::$tokenExpiryName]) {
            self::clearToken();
            return false;
        }
    ...
    public static function clearToken()
    {
        ...
        unset($_SESSION[self::$tokenExpiryName]);
    }
